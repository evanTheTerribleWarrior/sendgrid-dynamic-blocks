...
export const HANDLEBARS = {
    IF: { value: '{{#if', hasVariables: 1, hasClosingCondition: true, sameLevelConditions: ["ELSE_IF", "ELSE"]},
    ELSE_IF: { value: '{{else if', hasVariables: 1, hasClosingCondition: false, sameLevelConditions: ["ELSE_IF", "ELSE"]},
    ELSE: { value: '{{else', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: []},
    IF_CLOSE: { value: '{{/if', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    UNLESS: { value: '{{#unless', hasVariables: 1, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    UNLESS_CLOSE: { value: '{{/unless', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    GREATHER_THAN: { value: '{{#greaterThan', hasVariables: 2, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    GREATHER_THAN_CLOSE: { value: '{{/greaterThan', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    LESS_THAN: { value: '{{#lessThan', hasVariables: 2, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    LESS_THAN_CLOSE: { value: '{{/lessThan', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    EQUALS: { value: '{{#equals', hasVariables: 2, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    EQUALS_CLOSE: { value: '{{/equals', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    NOT_EQUALS: { value: '{{#notEquals', hasVariables: 2, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    NOT_EQUALS_CLOSE: { value: '{{/notEquals', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    AND: { value: '{{#and', hasVariables: 2, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    AND_CLOSE: { value: '{{/and', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
    OR: { value: '{{#or', hasVariables: 2, hasClosingCondition: true, sameLevelConditions: ["ELSE"]},
    OR_CLOSE: { value: '{{/or', hasVariables: 0, hasClosingCondition: false, sameLevelConditions: [], isClosingCondition: true},
